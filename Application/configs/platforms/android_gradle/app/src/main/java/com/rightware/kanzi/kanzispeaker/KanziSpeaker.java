package com.rightware.kanzi.kanzispeaker;
...
public class KanziSpeaker extends FragmentActivity
{
    private static final String TAG = "KanziSpeaker";
    ...
    protected void onCreate(Bundle icicle)
    {
        ...
        if (USE_DEBUG_TRACE)
        {
            Debug.startMethodTracing("kanzispeaker");
        }
